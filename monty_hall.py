...
{}
You can choose to either open the door you orignally picked or swap
...
You can read and explanation of why swapping is better at
...
while True:  # Main program loop.
    ...
    # Calculate sucess rate of swapping and not swapping:
